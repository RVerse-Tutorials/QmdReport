...
::: callout-warning
I am not running the gt() code because it will break all subsequent table numbering in the PDF output. HTML is ok but not PDF. GH issue posted to quarto-dev.
:::
...
-   A `gt()` call breaks all subsequent table numbering.
